...
@Immutable
data class BetterW4ExtendedColors(
...
fun BetterW4Theme(
    ...
    val extended = BetterW4ExtendedColors(
        statusChanged = StatusChanged,
        statusCancelled = StatusCancelled,
...
object BetterW4ThemeExtras {
    val extendedColors: BetterW4ExtendedColors
        @Composable
