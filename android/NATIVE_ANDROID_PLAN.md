...
Build a **native Android app** for BetterW4 that:
...
|----------|------|------|-------|
| **iOS (SwiftUI)** | `ios/BetterW4/` | Newest product UX; MitID WebView auth; rich schedule/messages/directory; Live Activities; Supabase sync | ~24k LOC Swift |
...
- [ ] Store listing assets (reuse Flutter icons / betterw4 branding).
...
| (skip) Supabase / analytics | Not ported — Android is Lectio/W4-only |
| Tab IA | `ContentView` |
...
6. UX is recognizably BetterW4 (iOS IA + brand), not a bare Material scaffold.
