# BetterW4 Android — Feature Parity Overview

> **Goal:** Native Android (`android/`) should have **full feature parity** with **iOS** (`ios/BetterW4`) and **Flutter** (`flutter/` + `flutter/lectio_wrapper`) combined, and feel **first-class**.  
> **Date:** 2026-07-10  
...
Android is a **first-class W4/Lectio client**: login + demo, 5-tab iOS IA, full daily path depth, directory pins/search, Glance widget, live-lesson boundaries, offline stores, help, and Play IAU.
...
|------------|---------|-------|
| School picker | ✅ | Scraped gym list + demo |
| MitID WebView | ✅ | |
...
| Subject colors/rename | ✅ | Lesson-mapping v2: SubjectMapper, local-only (friendly names + hues) |
...
| BetterW4 signature | ✅ | Append BBCode link; skip for teachers / settings toggle |
...
| Capability | Android |
|------------|---------|
| Homework groups + detail HTML + local done flags | ✅ |
...
| Optional Supabase / PostHog / in-app feedback | ❌ | Removed — app is local + W4/Lectio only |
