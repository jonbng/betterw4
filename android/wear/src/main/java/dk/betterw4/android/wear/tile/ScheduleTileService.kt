package dk.betterw4.android.wear.tile
...
import dk.betterw4.android.wear.MainActivity
import dk.betterw4.android.wear.R
import dk.betterw4.android.wear.data.WearScheduleRepository
...
class ScheduleTileService : Material3TileService() {
    override suspend fun MaterialScope.tileResponse(requestParams: TileRequest): Tile {
        ...
        val layout = primaryLayout(
            titleSlot = { text("BetterW4".layoutString) },
            mainSlot = {
                column(
