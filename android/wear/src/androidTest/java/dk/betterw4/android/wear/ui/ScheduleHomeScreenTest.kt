...
import dk.betterw4.android.wear.WearScheduleUiState
import dk.betterw4.android.wear.data.CachedWearSchedule
import dk.betterw4.android.wear.model.WearScheduleEvent
import dk.betterw4.android.wear.model.WearScheduleSnapshot
...
class ScheduleHomeScreenTest {
    ...
    fun agendaShowsCancelledLesson() {
        val cancelled = event("Physics", 10, 11).copy(
            status = dk.betterw4.android.wear.model.WearEventStatus.CANCELLED,
        )
        compose.setContent {
            BetterW4WearTheme {
